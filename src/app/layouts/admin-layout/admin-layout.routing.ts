...
import { AddFactureComponent } from 'app/add-facture/add-facture.component';
...
export const AdminLayoutRoutes: Routes = [
    ...
    { path: 'notifications',  component: RayonComponent},
     ...
     {path: 'facture', component: FactureComponent, children :[{path:'addfacture', component: AddFactureComponent}]},
];
